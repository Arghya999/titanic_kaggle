...
#SPLIT DATA INTO TRAINING VS TEST DATASET FOR CROSS VALIDATION
...
titanic.logistic.model <- glm(formula = titanic.training.data$Survived ~Pclass+Sex+Age+is.child,data = titanic.training.data, family = 'binomial')
titanic.logistic.model
View(titanic.training.data)
